...
public class Library {
 ...
 fis = new FileInputStream("D:\\naveenreddy\\ProjectDoneByHero\\src\\test\\resources\\configuration property\\config.property");
   prop = new Properties();
prop.load(fis);
String browser = prop.getProperty("browser");
  ...
  System.setProperty("webdriver.chrome.driver", "D:\\naveenreddy\\ProjectDoneByHero\\src\\test\\resources\\Drivers\\chromedriver.exe");
